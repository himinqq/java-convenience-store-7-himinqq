...
public class InputView {
    ...
    private static final String notifyOutOfStockNoPromotionMessage = "현재 {상품명} {수량}개는 프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)";
    ...
    public boolean requestApplyOutOfStockNoPromotion(){
        System.out.println(notifyOutOfStockNoPromotionMessage);
        String answer = reader.get();
        validateYesOrNoAnswer(answer);
        return answer.equals("Y");
    }
