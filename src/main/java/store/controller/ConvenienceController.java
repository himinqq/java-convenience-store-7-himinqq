...
public class ConvenienceController {
    ...
    private void validateExceedQuantity(){
    ...
    public void start() {
        ...
        String clientInput = inputView.requestPurchaseStock();
        buy.buyItemByClientInput(findProducts(clientInput),findQuantity(clientInput));
